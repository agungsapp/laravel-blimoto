																												...
																												<div class="product-detail product-detail2">
																														...
																														<div class="mt-2">
																																<div class="d-flex justify-content-between">
																																		...
																																		<p class="text-basic fw-bold">{{ Str::rupiah($item1->diskonMotor->diskon ?? '0') }}</p>
																																</div>
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon normal </p>
																																		<del
																																				class="text-basic">{{ Str::rupiah($item1->diskonMotor->diskon_promo ?? '0') }}</del>
																																</div>
																														</div>
																										...
																										<div class="product-box">
																												...
																												<div class="product-detail product-detail2">
																														...
																														<div class="mt-2">
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon promo </p>
																																		<p class="text-basic fw-bold">{{ Str::rupiah($item2->diskonMotor->diskon ?? '0') }}</p>
																																</div>
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon normal </p>
																																		<del
																																				class="text-basic">{{ Str::rupiah($item2->diskonMotor->diskon_promo ?? '0') }}</del>
																																</div>
																														</div>
																														<form action="{{ route('detail-motor') }}" method="GET">
																																@csrf
																										...
																										<div class="product-box">
																												...
																												<div class="product-detail product-detail2">
																														...
																														<div class="mt-2">
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon promo </p>
																																		<p class="text-basic fw-bold">{{ Str::rupiah($item3->diskonMotor->diskon ?? '0') }}
																																		</p>
																																</div>
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon normal </p>
																																		<del
																																				class="text-basic">{{ Str::rupiah($item3->diskonMotor->diskon_promo ?? '0') }}</del>
																																</div>
																														</div>
																														<form action="{{ route('detail-motor') }}" method="GET">
																																@csrf
																										...
																										<div class="product-box">
																												...
																												<div class="product-detail product-detail2">
																														...
																														<div class="mt-2">
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon promo </p>
																																		<p class="text-basic fw-bold">{{ Str::rupiah($item4->diskonMotor->diskon ?? '0') }}
																																		</p>
																																</div>
																																<div class="d-flex justify-content-between">
																																		<p class="text-doff">Diskon normal </p>
																																		<del
																																				class="text-basic">{{ Str::rupiah($item4->diskonMotor->diskon_promo ?? '0') }}</del>
																																</div>
																														</div>
																														<form action="{{ route('detail-motor') }}" method="GET">
																																@csrf
		...
		<section class="my-2">
				<div class="custom-container">
						<div class="row d-flex justify-content-center">
								...
								<div class="col-11 col-md-10 card-diskon-terbaik py-lg-0 pt-lg-4 overflow-hidden py-5 ps-5">
										...
										<div class="row">
												...
												<div class="col-12 col-lg-4 d-none d-lg-block h-100 p-0">
														<div class="w-100 h-100 d-flex justify-content-end align-items-end">
																<img src="{{ asset('assets') }}/images/custom/simulasi/simulasi.svg" class="w-75 h-100" style=""
																		alt="simulasi.png">
														</div>
												</div>
										</div>
										...
										@foreach ($best1 as $b1)
												<div class="item d-flex justify-content-center justify-content-md-start py-4">
														<div class="card rounded-3 shadow-home-card overflow-hidden" style="width: 16rem;">
																<img src="{{ asset('assets') }}/images/detail-motor/{{ $b1->image }}" alt="{{ $b1->image }}"
																		srcset="">
																<div class="p-3">
																		<p class="fw-bold fs-5 mb-2 text-black">{{ $b1->nama }}</p>


																		<div class="mt-2">
																				<div class="d-flex justify-content-between">
																						<p class="text-doff">Diskon promo </p>
																						<p class="text-basic fw-bold">{{ Str::rupiah($b1->diskonMotor->diskon ?? '0') }}</p>
																				</div>
																		...
																		<form class="mt-3" action="{{ route('detail-motor') }}" method="GET">
																				@csrf
																				<input class="id_lokasi" type="hidden" name="id_lokasi" value="1">
																				<input type="hidden" name="id_motor" value="{{ $b1->id }}">
								...
								<div class="owl-home-slider owl-theme position-relative overflow-hidden">
										@foreach ($blogs as $blog)
												<div class="item d-flex justify-content-center">
														<div class="card rounded-3 overflow-hidden" style="width: 15rem; min-height: 50px">
																<div class="card-body p-0">
																		<img src="{{ asset('assets') }}/images/thumbnail-blog/{{ $blog->thumbnail }}" class="img-fluid"
								...
								<div class="col-12">
										...
										<div class="mau-di-kasi-owl owl-carousel owl-theme">
												...
												@php
														...
														$nama = ['Karina Dewi', 'Layla Maunda', 'Ghea Syaputri', 'Amalia Safitri'];
														...
														<div class="item d-flex justify-content-center py-4">
																<div class="review-wrapper" style="width: 16rem;">
																		...
																		<div class="d-flex justify-content-center img-review">
																				<img class="img-fluid" style="width: 80%; "
