																								...
																								<div class="product-imgbox">
																										<div class="product-front">
																												<a href="product-page(left-sidebar).html">
																														<img src="{{ asset('assets') }}/images/detail-motor/{{ $item1->image }}" class="img-fluid"
																																alt="{{ $item1->image }}" />
																												</a>
																										</div>
																				...
																				<div>
																						<div class="product-box">
																								<div class="product-imgbox">
																										<div class="product-front">
																												<a href="product-page(left-sidebar).html">
																														<img src="{{ asset('assets') }}/images/detail-motor/{{ $item2->image }}" class="img-fluid"
																																alt="{{ $item2->image }}" />
																												</a>
																										</div>
																										<button type="button" class="btn btn-outline btn-cart">
																				...
																				<div>
																						<div class="product-box">
																								<div class="product-imgbox">
																										<div class="product-front">
																												<a href="product-page(left-sidebar).html">
																														<img src="{{ asset('assets') }}/images/detail-motor/{{ $item3->image }}" class="img-fluid"
																																alt="{{ $item3->image }}" />
																												</a>
																										</div>
																										<button type="button" class="btn btn-outline btn-cart">
																				...
																				<div>
																						<div class="product-box">
																								<div class="product-imgbox">
																										<div class="product-front">
																												<a href="product-page(left-sidebar).html">
																														<img src="{{ asset('assets') }}/images/detail-motor/{{ $item4->image }}" class="img-fluid"
																																alt="{{ $item4->image }}" />
																												</a>
																										</div>
																										<button type="button" class="btn btn-outline btn-cart">
												...
												<div class="d-flex position-relative">
														<div class="order-1">
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan2.webp"
																				alt="Honda Scoopy" title="Honda Scoopy"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan2.webp" />
																</div>
														</div>
														<div>
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan1.webp"
																				alt="Yamaha Fazzio" title="Yamaha Fazzio"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan1.webp"
								...
								<div class="col-md-4">
										<div class="collection-banner-main p-left banner-13 text-center">
												<div class="d-flex position-relative">
														<div class="order-1">
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan4.webp"
																				alt="Honda Scoopy" title="Honda Scoopy"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan4.webp" />
																</div>
														</div>
														<div>
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan3.webp"
																				alt="Yamaha Fazzio" title="Yamaha Fazzio"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan3.webp"
																				onclick="gd.common.goto('https://www.oto.com/en/motor-baru/yamaha/fazzio')" />
																</div>
														</div>
								...
								<div class="col-md-4">
										<div class="collection-banner-main p-left banner-13 text-center">
												<div class="d-flex position-relative">
														<div class="order-1">
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan6.webp"
																				alt="Honda Scoopy" title="Honda Scoopy"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan6.webp" />
																</div>
														</div>
														<div>
																<div class="image-wrapper">
																		<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan5.webp"
																				alt="Yamaha Fazzio" title="Yamaha Fazzio"
																				data-src="{{ asset('assets') }}/images/custom/perbandingan5.webp"
																				onclick="gd.common.goto('https://www.oto.com/en/motor-baru/yamaha/fazzio')" />
																</div>
														</div>
