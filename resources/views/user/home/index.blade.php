														...
														<div class="col-6 col-md-3">
																<div class="form-group">
																		...
																		<select id="dp" name="dp" class="js-example-basic-single form-select form-select-sm"
																				...
																				<option value="1000000">FIF : Rp. 1000000</option>
																				<option value="2000000">Adira : Rp. 2000000</option>
																				<option value="3000000">MCF : Rp. 3000000</option>
																				<option value="4000000">OTO : Rp. 4000000</option>
