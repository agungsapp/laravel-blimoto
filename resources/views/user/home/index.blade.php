					...
					<div class="row">
						<div class="d-flex align-items-center mt-5">
							<div class="col-8 d-flex">
								...
								<button id="btn-reset" class="btn btn-outline-basic btn-sm btn-submit ms-2 px-4 text-white" type="button">
									Reset
								</button>
							</div>
						</div>
		...
		<div class="modal-content">
			...
			<div id="modal-body" class="modal-body p-5">
				<div id="detail-motor-baru " class="row">
					...
					<div id="leasing-baru" class="col-12 col-md-6 content-slick-wrapper col-lg-8 col-xl-9 d-flex justify-content-center slick-result-modal mt-lg-0 mt-3 flex-row" style="flex-direction: row;">
					</div>
