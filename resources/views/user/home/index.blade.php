				...
				<div class="item d-flex justify-content-center">
					<div class="card rounded-3 card-berita-blog overflow-hidden">
						...
						<div class="card-footer border-0 bg-white py-3">
							<a href="{{ route('blog.show', $blog->slug) }}" class="btn-basic mt-3 rounded-lg px-3 py-1">Lihat
								Detail</a>
						</div>
					</div>
				</div>
		...
		<div class="row mb-3">
			...
			<div class="col-12">
				...
				<div class="owl-home-slider owl-theme position-relative overflow-hidden">
					...
					@for ($i = 0; $i < 4; $i++) <a class="item d-flex justify-content-center" tabindex="0" data-bs-toggle="modal"
		...
		<div class="row mb-3">
			...
			<div class="col-12">
				...
				<div class="mau-di-kasi-owl owl-carousel owl-theme">
					...
					@php
					$motor = ['Honda PCX', 'Honda PCX', 'BeAt Deluxe', 'Scoopy'];
					$img = ['testi1.webp', 'testi2.webp', 'testi3.webp', 'testi4.webp'];
					$nama = ['Agus Setiawan', 'Yunus Gunawan', 'Amalia Safitri', 'Gatot Edi Hidayat'];
					$review = [
					...
					{{-- item for loop review --}}
					@for ($i = 0; $i < 4; $i++) <div class="item d-flex justify-content-center h-100 py-4">
						<div class="review-wrapper" style="width: 16rem;">
							...
							<div class="d-flex justify-content-center img-review">
								{{-- <img class="img-fluid" style="" src="{{ asset('assets') }}/images/review/{{ $img[$i] }}"
									alt="{{ $img[$i] }}"> --}}
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="media">
					<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
						x="0px" y="0px" viewBox="0 0 417.12 417.12" style="enable-background:new 0 0 417.12 417.12;"
						xml:space="preserve">
						<g>
							<g>
								<path
...
@for ($i = 0; $i < 4; $i++) {{-- loop video pop up --}} <div class="modal modal-v-sec fade" id="dariblimoto{{ $i }}"
	role="dialog">
	<div class="modal-dialog modal-dialog-centered">
		<!-- Modal content-->
		<div class="modal-content">
