	...
	<div class="carousel-inner">
		...
		<div class="carousel-item {{ $hook->id == 1 ? 'active' : '' }}" data-bs-interval="3500">
			...
			<div class="carousel-caption d-none d-md-block">
				<a href="{{ $hook->link }}" style="background-color: {{ $hook->warna }}; color: {{ $hook->warna_teks }} ; font-weight: bold;" class="btn rounded-pill fs-sm-4 fs-md-4 fs-lg-4 px-5">Lihat Promo</a>
			</div>
		</div>
		@endforeach
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="{{ asset('assets') }}/images/detail-motor/{{ $item1->image }}" class="img-fluid" alt="{{ $item1->image }}" />
												</a>
											</div>
										...
										<div class="product-detail product-detail2">
											...
											{{-- <a href="/detail-motor/{{ $item1->id }}/{{ session('lokasiUser') }}"
											id="detail-link"
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="{{ asset('assets') }}/images/detail-motor/{{ $item2->image }}" class="img-fluid" alt="{{ $item2->image }}" />
												</a>
											</div>
											<div class="best-label">
												<div>Best DP</div>
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="{{ asset('assets') }}/images/detail-motor/{{ $item3->image }}" class="img-fluid" alt="{{ $item3->image }}" />
												</a>
											</div>
											<button type="button" class="btn btn-outline btn-cart">
												Lihat Promo
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="{{ asset('assets') }}/images/detail-motor/{{ $item4->image }}" class="img-fluid" alt="{{ $item4->image }}" />
												</a>
											</div>
											<button type="button" class="btn btn-outline btn-cart">
												Lihat Promo
			...
			<div class="col-11 col-md-10 card rounded-3 px-3 py-3">
				...
				<form id="form-simulasi" action="" class="mt-2">
					<div class="row">
						...
						<div class="col-6 col-md-3">
							<div class="form-group">
								...
								<select class="js-example-basic-single form-select form-select-sm" style="width: 100%" name="pembayaran">
					...
					<div class="row">
						...
						<div class="col-6 col-md-3">
							<div class="form-group">
								<label for="dp" class="mb-0" style="font-size: 12px">Dp</label>
								<select id="dp" name="dp" class="js-example-basic-single form-select form-select-sm" style="width: 100%" name="tenor">
									<option value="0" selected>-- Pilih DP --</option>
						...
						<div class="form-check" style="padding-left: 0 !important;" id="dp_lainnya">
									<input type="text" class="form-control" id="tujuanValidation4" placeholder="Masukan DP yang kamu inginkan" name="dp_lainnya">
								</div>
						</div>
					</div>
		...
		<div class="modal-content">
			...
			<div id="modal-body" class="modal-body p-5">
				<div id="detail-motor-baru" class="row">
					<div id="motor-baru" class="col-12 col-md-6 col-lg-4 col-xl-3 rounded-3 min-vh-50" style="box-shadow: 2px 2px 15px 2px rgba(0, 0, 0, 0.25); padding: 16px; border-radius: 20px">
					</div>
					<div id="leasing-baru" class="col-12 col-md-6 col-lg-8 col-xl-9 d-flex justify-content-center slick-result-modal mt-lg-0 mt-3 flex-row" style="flex-direction: row;">
					</div>
				</div>
				<div class="collection-img">
					<img class="w-100 mx-auto mt-5" src="{{ asset('assets') }}/images/custom/banner-Rekomendasi.webp" class="w-100" alt="banner">
				</div>
				...
				{{-- <div class="detail-motor">
												<section id="motor" class="section-big-pt-space b-g-light">
				...
				<div class="row">
					<div class="col-12">
						<div class="collection-banner-main p-left banner-13 banner-style7 text-center">
							<div class="collection-img">
								<img src="{{ asset('assets') }}/images/why/testimoni.webp" class="img-fluid bg-img" alt="banner" />
							</div>
							<div class="collection-banner-contain">
								<div>
									<h3>Testimoni</h3>
									...
									<div class="hotdeal-right-slick border-0">
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper" style="background-color: pink;">
												...
												<img src="/assets/images/produk-terbaru/Produk1.webp" alt="hot-deal" class="img-fluid bg-img" />

											</div>
										</a>
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper">
												<img src="/assets/images/produk-terbaru/Produk2.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper">
												<img src="/assets/images/produk-terbaru/Produk3.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper">
												<img src="/assets/images/produk-terbaru/Produk4.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper">
												<img src="/assets/images/produk-terbaru/Produk5.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="product-page(left-sidebar).html">
											<div class="img-wrraper">
												<img src="/assets/images/produk-terbaru/Produk6.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
									</div>
								</div>
					...
					<div>
						<div class="media-banner border-0">
							...
							<div class="media-banner-box">
								<div class="media">
									<a href="product-page(left-sidebar).html">
										<img style="width: 86px; height: 110px" src="{{ asset('assets') }}/images/custom/beat-green.png" class="img-fluid" alt="beat deluxe green" />
									</a>
							...
							<div class="media-banner-box">
								<div class="media">
									<a href="product-page(left-sidebar).html">
										<img style="width: 86px; height: 110px" src="{{ asset('assets') }}/images/custom/scopy-green.png" class="img-fluid" alt="banner" />
									</a>
									<div class="media-body">
										<div class="media-contant">
											<div>
							...
							<div class="media-banner-box">
								<div class="media">
									<a href="product-page(left-sidebar).html">
										<img style="width: 86px; height: 110px" src="{{ asset('assets') }}/images/custom/genio-green.png" class="img-fluid" alt="banner" />
									</a>
									<div class="media-body">
										<div class="media-contant">
											<div>
	...
	<div class="container-fluid">
		<div class="row collection2">
			...
			<div class="col-md-4">
					...
					<div class="d-flex position-relative">
						<div class="order-1">
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan2.webp" alt="Honda Scoopy" title="Honda Scoopy" data-src="{{ asset('assets') }}/images/custom/perbandingan2.webp" />
							</div>
						</div>
						<div>
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan1.webp" alt="Yamaha Fazzio" title="Yamaha Fazzio" data-src="{{ asset('assets') }}/images/custom/perbandingan1.webp" onclick="gd.common.goto('https://www.oto.com/en/motor-baru/yamaha/fazzio')" />
							</div>
						</div>
				...
				<div class="row bandingkan-range p-1">
					<div class="col-6 fw-bold ps-4 text-start">Rp. 45.000.000</div>
					<div class="col-6 fw-bold pe-4 text-end">Rp. 47.000.000</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="collection-banner-main p-left banner-13 text-center">
					<div class="d-flex position-relative">
						<div class="order-1">
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan4.webp" alt="Honda Scoopy" title="Honda Scoopy" data-src="{{ asset('assets') }}/images/custom/perbandingan4.webp" />
							</div>
						</div>
						<div>
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan3.webp" alt="Yamaha Fazzio" title="Yamaha Fazzio" data-src="{{ asset('assets') }}/images/custom/perbandingan3.webp" onclick="gd.common.goto('https://www.oto.com/en/motor-baru/yamaha/fazzio')" />
							</div>
						</div>
				...
				<div class="row bandingkan-range p-1">
					<div class="col-6 fw-bold ps-4 text-start">Rp. 20.000.000</div>
					<div class="col-6 fw-bold pe-4 text-end">Rp. 22.000.000</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="collection-banner-main p-left banner-13 text-center">
					<div class="d-flex position-relative">
						<div class="order-1">
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan6.webp" alt="Honda Scoopy" title="Honda Scoopy" data-src="{{ asset('assets') }}/images/custom/perbandingan6.webp" />
							</div>
						</div>
						<div>
							<div class="image-wrapper">
								<img class="img-fluid" src="{{ asset('assets') }}/images/custom/perbandingan5.webp" alt="Yamaha Fazzio" title="Yamaha Fazzio" data-src="{{ asset('assets') }}/images/custom/perbandingan5.webp" onclick="gd.common.goto('https://www.oto.com/en/motor-baru/yamaha/fazzio')" />
							</div>
						</div>
				...
				<div class="row bandingkan-range p-1">
					<div class="col-6 fw-bold ps-4 text-start">Rp. 18.000.000</div>
					<div class="col-6 fw-bold pe-4 text-end">Rp. 19.000.000</div>
				</div>
			</div>
			...
			<!-- <div class="col-md-4">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																								<div class="collection-banner-main p-left banner-style3 banner-13 text-center">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											<div class="collection-img bg-size" style="background-image: url(&quot;assets/images/custom/compare.png&quot;); background-size: cover; background-position: center center; display: block;"> <img src="{{ asset('assets') }}/images/custom/compare.png" class="img-fluid bg-img" alt="banner" style="display: none;"> </div>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											<div class="collection-banner-contain">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																														<div>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																	<h3>best discount </h3>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																	<h4>cordless tools</h4>
			...
			<!-- <div class="col-md-4">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																								<div class="collection-banner-main banner-style3 p-left banner-13 text-center">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											<div class="collection-img bg-size" style="background-image: url(&quot;assets/images/tools/collection-banner/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="{{ asset('assets') }}/images/tools/collection-banner/2.jpg" class="img-fluid bg-img" alt="banner" style="display: none;"> </div>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											<div class="collection-banner-contain">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																														<div>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																	<h3>up to 50% off</h3>
		...
		<div class="row">
			<div class="col">
				<div class="collection-banner-main banner-5 p-center">
					<div class="collection-img" style="
						...
						<div class="blog-contain">
							<div class="blog-img">
								<a href="{{ route('blog.show', $blog->id) }}">
									<img src="/assets/images/thumbnail-blog/{{ $blog->thumbnail }}" alt="blog thumbnail" class="img-fluid w-100" />
								</a>
							</div>
		...
		<div class="row">
			<div class="col-12 position-relative">
				<div class="video-banner-contain">
					<div>
						<a class="video-btn" tabindex="0" data-bs-toggle="modal" data-bs-target="#v-section1"><i class="fa fa-play"></i></a>
						...
						<div class="card px-3 py-3">
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-2">
										<a href="https://www.google.com/maps/dir/?api=1&amp;origin=My+Location&amp;destination=-8.65861,%20115.210666&amp;travelMode=motorcycle">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 slide-mitra-kami">
				...
				<div>
					<div class="card d-flex justify-content-center align-items-center px-3 py-2" style="width: 100px; height: 80px; padding: 2rem">
			...
			<div class="row">
				<div class="col">
					<div class="banner-contain">
						...
						<!-- <h3>food market</h3> -->
						<!-- <h4>special offer</h4> -->
						<a href="#" class="btn bg-basic btn-rounded fs-3 mt-3 px-5"><i class="fa fa-whatsapp" aria-hidden="true"></i><span class="ms-1">Ajukan Sekarang</span></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal modal-v-sec fade" id="v-founder" role="dialog">
	<div class="modal-dialog modal-dialog-centered">
		...
		<div class="modal-content">
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/X8ohxpWhWOA?si=kUNP41h87pjEdCMl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
		</div>
	</div>
</div>
