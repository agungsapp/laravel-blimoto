								...
								<div class="col-11 col-md-10 card-diskon-terbaik px-5 py-5">
										...
										<div class="row">
												...
												<div class="col-12 col-lg-4">
														<img src="{{ asset('assets') }}/images/custom/simulasi/simulasi.png" class="img-fluid w-50 w-lg-100"
																alt="simulasi.png">
												</div>
										</div>
								</div>
		...
		<div class="container mt-4">
				<div class="row">
						...
						<div class="col-12">
								...
								@php
										$motor_terbaru = ['2023-10-13_Produk Promo BEAT CBS BLACK.webp', '2023-10-13_Produk Promo Deluxe Silver.webp', '2023-10-13_Produk Promo CB150X GREEN.webp', '2023-10-13_Produk Promo V160 CBS WHITE gold.webp'];
								@endphp

								<div class="owl-carousel d-flex">
										@for ($i = 0; $i < 4; $i++)
												<div class="item">
														<div class="card rounded-3 overflow-hidden" style="width: 17rem;">
				...
				<div class="container">
						<div class="row">
								<div class="col-12 p-0">
										<p class="fs-4 fw-bold mb-4 text-black">Review Pengguna</p>
								</div>
						</div>
						<div class="row mb-3">
								<div class="col-12">
