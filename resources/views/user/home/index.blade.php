...
@section('content')
						...
						<div class="row mb-3">
								...
								<div class="col-12">
										@php
												...
												$link = ['https://youtu.be/3g4hMdYp8Ug?si=0HgD6sVKO9BkKWpr', 'https://youtu.be/1QVGV5wEMU8?si=lX6XpKc6wb6yJqEb', 'https://youtu.be/8atEqcpHgNU?si=W-sLmE-N6NMzFD2P', 'https://youtu.be/7tDfPq0kzrs?si=wYGxbp8fasQz4uQY', 'https://youtu.be/kdBAMAXRTGg?si=oYuZPKblPr-2t_Wd'];
										@endphp
										{{-- owl --}}
										<div class="owl-home-slider owl-theme position-relative overflow-hidden">
						...
						<div class="row mb-3">
								...
								<div class="col-12">
										...
										<div class="mau-di-kasi-owl owl-carousel owl-theme">
												...
												@php
														$motor = ['Scoopy', 'Honda PCX', 'Honda PCX', 'BeAt Deluxe'];
		...
		@php
				$link_bli = ['https://www.youtube.com/embed/3g4hMdYp8Ug?si=hbiClKS_ibe4jOGH', 'https://www.youtube.com/embed/1QVGV5wEMU8?si=s4HPsOCR5ERGP5dg', 'https://www.youtube.com/embed/8atEqcpHgNU?si=PZcGD4U7H6XFJUHP', 'https://www.youtube.com/embed/7tDfPq0kzrs?si=klI_0aFQoVWsTeYu', 'https://www.youtube.com/embed/3g4hMdYp8Ug?si=60pAlHI_goBJaYo3'];
		@endphp
		...
		@for ($i = 0; $i < 4; $i++)
				...
				<div class="modal modal-v-sec fade" id="dariblimoto{{ $i }}" role="dialog">
						<div class="modal-dialog modal-dialog-centered">
								<!-- Modal content-->
								<div class="modal-content">
										<iframe width="560" height="315" src="{{ $link_bli[$i] }}" title="YouTube video player" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
												allowfullscreen></iframe>
								</div>
						</div>
