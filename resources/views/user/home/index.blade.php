										...
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="assets/images/detail-motor/{{ $item1->image }}" class="img-fluid" alt="{{ $item1->image }}" />
												</a>
											</div>
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="assets/images/detail-motor/{{ $item2->image }}" class="img-fluid" alt="{{ $item2->image }}" />
												</a>
											</div>
											<button type="button" class="btn btn-outline btn-cart">
												Lihat Promo
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="assets/images/detail-motor/{{ $item3->image }}" class="img-fluid" alt="{{ $item3->image }}" />
												</a>
											</div>
											<button type="button" class="btn btn-outline btn-cart">
												Lihat Promo
								...
								<div>
									<div class="product-box">
										<div class="product-imgbox">
											<div class="product-front">
												<a href="product-page(left-sidebar).html">
													<img src="assets/images/detail-motor/{{ $item4->image }}" class="img-fluid" alt="{{ $item4->image }}" />
												</a>
											</div>
											<button type="button" class="btn btn-outline btn-cart">
												Lihat Promo
						...
						<div class="modal-content">
								...
								<div class="modal-body p-5">
										<div id="detail-motor-baru" class="row">
												<div id="motor-baru" class="col-3 rounded-3"
														style="box-shadow: 2px 2px 15px 2px rgba(0, 0, 0, 0.25); padding: 16px; border-radius: 20px">
														<img src="/assets/images/detail-motor/3.webp" class="img-fluid" alt="3.webp" srcset=""
												...
												<div id="leasing-baru" class="col-9 d-flex slick-result-modal flex-row" style="flex-direction: row;">
														<div class="p-3" style="padding: 20px !important;">
																<div class="card" style="width: 14rem; margin-left: 10px; margin-bottom: 20px;">
																		<img src="/assets/images/leasing/fif.jpg" class="card-img-top" alt="fif">
																		<div class="card-body">
														...
														<div class="p-3" style="padding: 20px !important;">
																<div class="card" style="width: 14rem; margin-left: 10px; margin-bottom: 20px;">
																		<img src="/assets/images/leasing/fif.jpg" class="card-img-top" alt="fif">
																		<div class="card-body">
																				<h5 class="card-title">FIF DUA</h5>
																		</div>
																		<ul class="list-group list-group-flush">
																				<li class="list-group-item d-flex justify-content-between">
																						<p>DP</p>
														...
														<div class="p-3" style="padding: 20px !important;">
																<div class="card" style="width: 14rem; margin-left: 10px; margin-bottom: 20px;">
																		<img src="/assets/images/leasing/fif.jpg" class="card-img-top" alt="fif">
																		<div class="card-body">
																				<h5 class="card-title">FIF GROUP TIGA</h5>
																		</div>
																		<ul class="list-group list-group-flush">
																				<li class="list-group-item d-flex justify-content-between">
																						<p>DP</p>
				...
				<div class="row">
					<div class="col-12">
						<div class="collection-banner-main p-left banner-13 banner-style7 text-center">
							<div class="collection-img">
								<img src="assets/images/custom/test.webp" class="img-fluid bg-img" alt="banner" />
							</div>
							<div class="collection-banner-contain">
								<div>
									<h3>Testimoni</h3>
					...
					<div class="col-12">
						<div class="collection-banner-main p-left banner-13 banner-style7 text-center">
							<div class="collection-img">
								<img src="assets/images/custom/leasing_new.webp" class="img-fluid bg-img" alt="banner" />
							</div>
							<div class="collection-banner-contain">
								<div>
									<h3>Leasing</h3>
