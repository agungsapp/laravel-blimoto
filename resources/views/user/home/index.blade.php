							...
							<div class="row hot-deal-subcontain hotdeal-block1">
									...
									<div class="hotdeal-right-slick border-0">
										<a href="#">
											<div class="img-wrraper" style="background-color: pink;">
												...
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk1.webp" alt="hot-deal" class="img-fluid bg-img" />

											</div>
										</a>
										<a href="#">
											<div class="img-wrraper">
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk2.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="#">
											<div class="img-wrraper">
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk3.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="#">
											<div class="img-wrraper">
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk4.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="#">
											<div class="img-wrraper">
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk5.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
										<a href="#">
											<div class="img-wrraper">
												<img src="{{ asset('assets') }}/images/produk-terbaru/Produk6.webp" alt="hot-deal" class="img-fluid bg-img" />
											</div>
										</a>
									</div>
								</div>
									...
									<div class="hotdeal-right-slick border-0">
										<div>
											<div>
												...
												<a href="#" class="btn btn-normal btn-md">shop now</a>
											</div>
										</div>
										<div>
											<div>
								...
								<div class="col-md-2">
									<div class="hotdeal-right-nav">
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak1.webp" alt="hot-dea" class="img-fluid" />
										</div>
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak2.webp" alt="hot-dea" class="img-fluid" />
										</div>
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak3.webp" alt="hot-dea" class="img-fluid" />
										</div>
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak4.webp" alt="hot-dea" class="img-fluid" />
										</div>
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak5.webp" alt="hot-dea" class="img-fluid" />
										</div>
										<div>
											<img src="{{ asset('assets') }}/images/produk-terbaru/Produk-kotak6.webp" alt="hot-dea" class="img-fluid" />
										</div>
									</div>
								</div>
							</div>
			...
			<div class="owl-home-slider owl-theme position-relative overflow-hidden">
				...
				<div class="item d-flex justify-content-center justify-content-md-start py-4">
					<div class="card rounded-3 shadow-home-card overflow-hidden">
						<img src="{{ asset('assets') }}/images/detail-motor/{{ $pop->image }}" alt="{{ $pop->image }}" srcset="">
						<div class="p-3">
	...
	<div class="row">
		...
		<div class="col-12">
			<div class="owl-home-slider owl-theme position-relative overflow-hidden">
				...
				<div class="item d-flex justify-content-center justify-content-md-start py-4">
					<div class="card rounded-3 shadow-home-card overflow-hidden">
						<img src="{{ asset('assets') }}/images/detail-motor/{{ $baru->image }}" alt="{{ $baru->image }}" srcset="">
						<div class="p-3">
				...
				<div class="item d-flex justify-content-center">
					<div class="card rounded-3 card-berita-blog overflow-hidden">
						<div class="card-body p-0">
							<img src="{{ asset('assets') }}/images/thumbnail-blog/{{ $blog->thumbnail }}" class="img-fluid" alt="{{ $blog->thumbnail }}" srcset="">
		...
		<div class="row mb-3">
			...
			<div class="col-12">
				...
				<div class="owl-home-slider owl-theme position-relative overflow-hidden">
					...
					@for ($i = 0; $i < 4; $i++) <div class="item d-flex justify-content-center">
						<div class="card rounded-3 card-video-blimotot overflow-hidden">
							<img src="{{ asset('assets') }}/images/custom/video-blimoto/{{ $thumbnail[$i] }}" alt="2023-10-13_Produk Promo BEAT CBS BLACK.webp" srcset="">
							<div class="p-3">
		...
		<div class="row mb-3">
			...
			<div class="col-12">
				...
				<div class="mau-di-kasi-owl owl-carousel owl-theme">
					...
					@php
					$img = ['test1.jpg', 'testi2.jpg', 'testi3.jpg', 'testi4.jpg'];
					$nama = ['Karina Dewi', 'Liondra Wijayanto', 'Rama Yanto Sukoco', 'Amalia Safitri'];
					$review = ['Harga terbaik untuk area Jabodetabek', 'CS nya ramah banget, Syarat pengajuan kreditnya juga gampang', 'Kenapa ga ada dari dulu ya biar mudah', 'Sangat membantu, bisa tau harga motor sekarang tanpa harus ke delaer ❤'];
					@endphp

					{{-- item for loop review --}}
					@for ($i = 0; $i < 4; $i++) <div class="item d-flex justify-content-center py-4 h-100">
						<div class="review-wrapper" style="width: 16rem;">
							...
							<div class="d-flex justify-content-center img-review">
								<img class="img-fluid" style="width: 80%; max-height: 200px;" src="{{ asset('assets') }}/images/review/{{ $img[$i] }}" alt="{{ $img[$i] }}">
							</div>
