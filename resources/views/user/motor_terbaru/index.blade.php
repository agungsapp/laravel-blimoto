							...
							<div class="collection-collapse-block-content">
								<div class="filter-harga-wrapper mt-3">
									<div class="input-group mb-3">
										...
										<input id="min" type="text" class="form-control" aria-label="Sizing example input" onkeyup="formatRupiah(this)" aria-describedby="inputGroup-sizing-default" value="">
									</div>
									<div class="input-group mb-3">
										<span class="input-group-text" id="inputGroup-sizing-default">Max</span>
										<input onkeyup="formatRupiah(this)" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
									</div>
										...
										<div class="row">
											<div class="col-12">
												<ul class="text-lg-center text-start" style="font-size: medium">
													...
													<li>
														<select id="sortHarga" class="form-select" style="width: fit-content" aria-label="Default select example">
