												...
												<div class="card-body">
														<div class="row">
																<div class="form-group col-md-6">
																		...
																		<input name="nama" type="text" class="form-control" placeholder="Masukan nama CEO"
																				value="{{ old('nama') }}">
																</div>
																<div class="form-group col-md-6">
																		<label for="input-username">Username</label>
																		<input name="username" type="text" class="form-control" id="input-username"
																				placeholder="Masukan username CEO" value="{{ old('username') }}">
																</div>
														</div>
														<div class="row">
																<div class="form-group col-md-6">
																...
																<tbody>
																		@foreach ($ceo as $index => $sale)
																				<tr role="row" class="{{ $index % 2 == 0 ? 'even' : 'odd' }}">
																						...
																						<td>
																								<div class="btn-group">
																										<form action="{{ route('admin.ceo.destroy', $sale->id) }}" method="post">
																								...
																								<div class="modal fade" id="modalEdit{{ $sale->id }}" tabindex="-1" role="dialog"
																										...
																										<div class="modal-dialog" role="document">
																												<div class="modal-content">
																														...
																														<form action="{{ route('admin.ceo.update', $sale->id) }}" method="post">
																																@csrf
																																@method('PUT')
																																				...
																																				<div class="card-body">
																																						<div class="form-group">
																																								...
																																								<input name="nama" type="text" class="form-control"
																																										placeholder="Masukan nama CEO" value="{{ $sale->nama }}">
																																						</div>
																																						<div class="form-group">
																																								<label for="input-username">Username</label>
																																								<input name="username" type="text" class="form-control" id="input-username"
																																										placeholder="Masukan username ceo)" value="{{ $sale->username }}">
																																						</div>
																																						<div class="form-group">
																																								<label for="input-password">Password</label>
