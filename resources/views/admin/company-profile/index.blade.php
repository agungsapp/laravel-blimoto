																		...
																		<tr>
																				...
																				<td>
																						<div class="d-flex justify-content-between">
																								<button data-toggle="modal" data-target="#modalEdit{{ $c->id }}"
																										class="btn btn-warning">Edit</button>
																								<button class="btn btn-success" data-toggle="modal"
																										data-target="#modal-view-gambar-{{ $c->id }}" data-placement="top"
																						...
																						<div class="modal fade" id="modalEdit{{ $c->id }}" tabindex="-1" role="dialog"
																								...
																								<div class="modal-dialog" role="document">
																										<div class="modal-content">
																												...
																												<form action="{{ route('admin.company-profile.update', $c->id) }}" method="post"
																														...
																														<div class="card-body">
																																<div class="form-group">
																																		<label for="nama">Nama Perusahaan</label>
																																		<input type="text" class="form-control" id="nama" name="nama"
																																				placeholder="masukan nama perusahaan ..." value="{{ $c->nama_perusahaan }}">
																																</div>
																																<div class="form-group">
																																		<label for="alamat">Alamat</label>
																																		<input type="text" class="form-control" id="alamat" name="alamat"
																																				placeholder="masukan alamat" value="{{ $c->alamat }}">
																																</div>
																																<div class="form-group">
																																		<label for="no">No WA</label>
																																		<input type="text" class="form-control" id="no" name="no"
																																				placeholder="masukan no WA ..." value="{{ $c->no_wa }}">
																																</div>
																																<div class="form-group">
																																		<label for="logo">Logo Company</label>
																																		<br />
																						...
																						<div class="modal fade" id="modal-view-gambar-{{ $c->id }}" tabindex="-1"
