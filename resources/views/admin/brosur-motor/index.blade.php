								...
								<div class="card">
										...
										<div class="card-body">
												<div class="table-responsive">
														<table id="data-brosur" class="table-bordered table-striped dataTable table" role="grid"
																						...
																						<td>
																								<div class="btn-group">
																										<button type="button" class="btn btn-warning" data-toggle="modal"
																												data-target="#modalEdit{{ $brosur->id }}">
																												Edit
																										</button>
																										<button class="btn btn-success" data-toggle="modal" data-target="#modalView{{ $brosur->id }}"
																												data-placement="top" title="View PDF file">Lihat</button>
																								...
																								<!-- Modal update -->
																								<div class="modal fade" id="modalEdit{{ $brosur->id }}" tabindex="-1" role="dialog"
																										...
																										<div class="modal-dialog" role="document">
																												<div class="modal-content">
																														...
																														<form action="{{ route('admin.brosur-motor.update', $brosur->id) }}" method="post"
																																...
																																<div class="modal-body">
																																		<div class="card card-primary">
																																				...
																																				<div class="card-body">
																																						<div class="form-group">
																																								<label>Nama Motor</label>
																																								<input type="text" class="form-control" value="{{ $brosur->motor->nama }}"
																																										disabled="">
																																						</div>
																																						<div class="form-group">
																																								<label>Is Populer</label>
																																								<select name="is-popular" class="form-control">
																																										<option value="0" {{ $brosur->is_popular == 0 ? 'selected' : '' }}>Tidak
																																												Populer</option>
																																										<option value="1" {{ $brosur->is_popular == 1 ? 'selected' : '' }}>Populer
																																										</option>
																																								</select>
																																						</div>
																																						<div class="form-group">
																								...
																								<!-- end modal update -->
																								<!-- modal view pdf -->
																								<div class="modal fade" id="modalView{{ $brosur->id }}" tabindex="-1" role="dialog"
																										aria-labelledby="myModalLabel">
																										<div class="modal-dialog" role="document">
																												<div class="modal-content">
																														<div class="modal-header">
																														...
																														<div class="modal-body">
																																<embed src="{{ '/assets/pdfs/' . $brosur->nama_file }}" width="100%" height="500"
																																		alt="pdf" />
																														</div>
																														<div class="modal-footer">
