	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				{{-- master pembayaran --}}
				<li class="nav-item {{ \Route::is('admin.sudah-bayar') || \Route::is('admin.belum-bayar') ? 'menu-open' : '' }}">
					<a href="#" class="nav-link {{ \Route::is('admin.sudah-bayar') || \Route::is('admin.belum-bayar') ? 'active' : '' }}">
						<i class="nav-icon fas fa-city"></i>
						<p>
							Data Pembayaran
							<i class="right fas fa-angle-left"></i>
				...
				<li class="nav-item">
					<a href="{{ route('admin.leasing-motor.index') }}" class="nav-link {{ \Route::is('admin.leasing-motor.*') ? 'active' : '' }}">
				...
				<li class="nav-item">
					<a href="{{ route('admin.dealer-motor.index') }}" class="nav-link {{ \Route::is('admin.dealer-motor.*') ? 'active' : '' }}">
				...
				<li class="nav-item">
					<a href="{{ route('admin.mitra.index') }}" class="nav-link {{ \Route::is('admin.mitra.*') ? 'active' : '' }}">
			...
			{{-- master sales --}}
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				<li class="nav-item {{ \Route::is('admin.sales.*') || \Route::is('admin.penjualan.data.*') ? 'menu-open' : '' }}">
					<a href="#" class="nav-link {{ \Route::is('admin.sales.*') || \Route::is('admin.penjualan.data.*')  ? 'active' : '' }}">
						<i class="nav-icon fas fa-city"></i>
						<p>
							Master Sales
							<i class="right fas fa-angle-left"></i>
				...
				<li class="nav-item">
					<a href="{{ route('admin.sales-settings.index') }}" class="nav-link {{ \Route::is('admin.sales-settings.*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-users"></i>
						<p>
							Setting Akun
						</p>
