            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header with-border">
                        <h3 class="card-title">Input Data Area Manager</h3>
                    </div>
                    <form action="{{ route('admin.area-manager.store') }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="input-nama">Nama Area Manager</label>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Data Akun Area Manager</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($ceo as $index => $sale)
                                        <tr role="row" class="{{ $index % 2 == 0 ? 'even' : 'odd' }}">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form action="{{ route('admin.area-manager.destroy', $sale->id) }}"
                                                        method="post">
                                                ...
                                                <div class="modal fade" id="modalEdit{{ $sale->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('admin.area-manager.update', $sale->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('PUT')
