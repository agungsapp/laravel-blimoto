								...
								<form action="{{ route('admin.best-motor.store') }}" method="post">
										...
										<div class="card-body">
												<div class="form-group">
														...
														<input name="nama" type="text" class="form-control" id="exampleInputTypeMotor"
																placeholder="Masukan kategori best motor (Diskon Terbaik, DP Terumurah, Harga Terbawah, dll)">
												</div>
										</div>
																...
																<tr>
																		...
																		<td>
																				<div class="d-flex justify-content-between">
																						<div class="btn-group">
																								<form action="{{ route('admin.best-motor.destroy', $best_motor->id) }}" method="post">
																										...
																										<button type="button" class="btn btn-primary" data-toggle="modal"
																												data-target="#modalEdit{{ $best_motor->id }}">
																												Edit
																										</button>
																										@csrf
																										@method('DELETE')
																						...
																						<!-- Modal update -->
																						<div class="modal fade" id="modalEdit{{ $best_motor->id }}" tabindex="-1" role="dialog"
																										...
																										<div class="modal-content">
																												...
																												<form action="{{ route('admin.best-motor.update', $best_motor->id) }}" method="post">
																														...
																														<div class="modal-body">
																																<div class="form-group">
																																		<label for="exampleInputTypeMotor">Nama Kategori Best Motor</label>
																																		<input name="nama_edit" type="text" class="form-control" id="exampleInputTypeMotor"
																																				placeholder="Masukan kategori best motor (Diskon Terbaik, DP Terumurah, Harga Terbawah, dll)"
																																				value="{{ $best_motor->nama }}">
																																</div>
																														</div>
